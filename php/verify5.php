                    ...
                    <div class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding blur">1504 Walnut Drive</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">City</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding blur">Farmington</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">County</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding blur">Monroe</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                    ...
                    <div class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding blur">6</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">Tax Marital Status</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding blur">M</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">Fed Withholding Amt</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding blur">$500</span><a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                    ...
                    <div class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding blur">Theresa Smithers, Other</span><a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
