                    ...
                    <div ng-repeat="group in section.fieldGroups" class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding blur">1504 Walnut Drive</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding blur">Farmington</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                            <div class="row">
                                <div class="col-sm-3"><span ng-bind="field.label" class="ng-binding">County</span>:</div>
                                <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding blur">Monroe</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                            <div class="row">
                    ...
                    <div ng-repeat="group in section.fieldGroups" class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding blur">6</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                            <div class="row">
                                <div class="col-sm-3"><span ng-bind="field.label" class="ng-binding">Tax Marital Status</span>:</div>
                                <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding blur">M</span> <a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                            <div class="row">
                                <div class="col-sm-3"><span ng-bind="field.label" class="ng-binding">Fed Withholding Amt</span>:</div>
                                <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding blur">$500</span><a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
                    ...
                    <div ng-repeat="group in section.fieldGroups" class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding blur">Theresa Smithers, Other</span><a href="#" class="unmask" style="font-style:italic;padding-left: 5px;">view</a></span> </div>
                            </div>
                        </div>
