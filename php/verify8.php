    ...
    <div class="main-content container" role="main">
        <div id="main-content">
            <?php include ('includes/instructions-top.php') ?>
                  ...
                  <div class='overlay-maskdata'> <p>Contains personal data</p>   <button class="btn btn-lg btn-primary" id="showdata"> Show data</button> <button class="btn btn-lg btn-default" id=""> Verify later</button></div>
                <div class="row">
                    <div class="col-xs-6">
                    ...
                    <div class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding">1504 Walnut Drive</span></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">City</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding">Farmington</span></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">County</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding">Monroe</span></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                    ...
                    <div class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding">6</span></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">Tax Marital Status</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding">M</span></span> </div>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="row">
                                <div class="col-sm-3"><span class="ng-binding">Fed Withholding Amt</span>:</div>
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding">$500</span></span> </div>
                            </div>
                        </div>
                    ...
                    <div class="ng-scope">
                        <div class="form-group form-group-sm ng-scope" style="">
                            <div class="row">
                                ...
                                <div class="col-sm-9"> <span class="ng-scope"><span class="ng-binding">Theresa Smithers, Other</span></span> </div>
                            </div>
                        </div>
