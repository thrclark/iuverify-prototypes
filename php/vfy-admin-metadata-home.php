                    ...
                    <div class="primary-content">
                        <section>
                            <div class="row section-head">
                                ...
                                <div class="col-xs-12  col-sm-3 section-controls"> <a href="vfy-admin-metadata-new.php" class="btn btn-xs btn-default"> <i class="fa fa-plus" aria-hidden="true"></i> Metadata</a> </div>
                            </div>
