...
<div class="main-content container" role="main">
    <div id="main-content">
        ...
        <div ng-repeat="section in verify.verification.sections" class="well vfy-section ng-scope" style="">
            ...
            <button class="btn btn-xs btn-primary reveal" style="margin-top:1rem">Reveal sensitive data</button>  <button class="btn btn-xs btn-default" id="skipfornow" style="margin-top:1rem" onclick="alert('Verification is now deferred, and user is redirected to application.');">Skip for now</button>
            <hr>
                ...
                <div ng-repeat="group in section.fieldGroups" class="ng-scope">
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields" style="">
                        <div class="row">
                            ...
                            <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding privatedata" style="display:none;">1504 Walnut Drive</span> <span class="mask"><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i></span></span> </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                        <div class="row">
                            ...
                            <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding privatedata" style="display:none;">Farmington</span> <span class="mask"><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i></span> </span> </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                        <div class="row">
                            <div class="col-sm-3"><span ng-bind="field.label" class="ng-binding">County</span>:</div>
                            <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding privatedata" style="display:none;">Monroe</span> <span class="mask"><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i></span></span> </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                        <div class="row">
                ...
                <div ng-repeat="group in section.fieldGroups" class="ng-scope">
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields" style="">
                        <div class="row">
                            ...
                            <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding privatedata" style="display:none;">6</span> <span class="mask"><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i></span></span> </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                        <div class="row">
                            <div class="col-sm-3"><span ng-bind="field.label" class="ng-binding">Tax Marital Status</span>:</div>
                            <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding privatedata" style="display:none;">M</span> <span class="mask"><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i></span></span> </div>
                        </div>
                    </div>
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields">
                        <div class="row">
                            <div class="col-sm-3"><span ng-bind="field.label" class="ng-binding">Fed Withholding Amt</span>:</div>
                            <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding privatedata" style="display:none;">$500</span> <span class="mask"><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i></span></span> </div>
                        </div>
                    </div>
                ...
                <div ng-repeat="group in section.fieldGroups" class="ng-scope">
                    <div class="form-group form-group-sm ng-scope" ng-repeat="field in group.fields" style="">
                        <div class="row">
                            ...
                            <div class="col-sm-9"> <span ng-repeat="value in field.values" class="ng-scope"><span ng-bind="value" class="ng-binding privatedata" style="display:none;">Theresa Smithers, Other</span> <span class="mask"><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i><i class="fa fa-circle"></i></span></span> </div>
                        </div>
                    </div>
        ...
        <div class="submission">
            ...
            <fieldset id="fieldset1">
                ...
                <div class="alert alert-danger" role="alert" style="display:none"><!---->
                    ...
                    <button class="btn btn-xs btn-default reveal" id="revealbutton" style="margin-top:1rem">Reveal sensitive data</button>
                </div>
                <div class="row">
                    <div class="col-md-12 text-center" style="padding-bottom:15px; padding-top:15px;">
                        <button class="btn btn-lg btn-primary" id="submit1_1" data-toggle="" data-target="" disabled> Submit</button>
                        <button class="btn btn-lg btn-primary" id="submit1_2" data-toggle="" data-target="" onclick="alert('Verification is now deferred, and user is redirected to application.');"  style="display:none"> Submit</button>
                    </div>
                </div>
            </fieldset>
            <fieldset id="fieldset2" style="display:none">
                ...
                <div class="row">
                    <div class="col-md-12 text-center" style="padding-bottom:15px; padding-top:15px;">
                        <button class="btn btn-lg btn-primary" id="submit2" data-toggle="" data-target="" disabled onclick="alert('Verification is now deferred/completed, and user is redirected to application.');"> Submit</button>
                    </div>
                </div>
            </fieldset>
        </div>
