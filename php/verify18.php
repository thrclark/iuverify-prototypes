...
<div class="main-content container" role="main">
    <div id="main-content">
        ...
        <div class="well vfy-section ng-scope" style="">
            ...
            <button class="btn btn-xs btn-primary reveal" style="margin-top:1rem">Reveal sensitive data</button>  <button class="btn btn-xs btn-default" id="skipfornow" style="margin-top:1rem" onclick="alert('Design note - verification is now deferred, and user is redirected to application.');">Skip for now</button>
            <hr>
