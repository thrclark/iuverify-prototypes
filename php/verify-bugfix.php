                ...
                <div class="form-horizontal">
                    <div class="ng-scope">
                        <div class="form-group form-group-sm ng-scope">
                            <div class="col-sm-3 control-label"><span class="ng-binding">Landline 1</span>:</div>
                            <div class="col-sm-9">
                                <p class="form-control-static"><span class="ng-scope"><span class="ng-binding">(812) 856-2329</span></span></p>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="col-sm-3 control-label"><span class="ng-binding">Cellular 1</span>:</div>
                            <div class="col-sm-9">
                                <p class="form-control-static"><span class="ng-scope"><span class="ng-binding">(812) 369-9664</span></span></p>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="col-sm-3 control-label"><span class="ng-binding">IU Email</span>:</div>
                            <div class="col-sm-9">
                                <p class="form-control-static"><span class="ng-scope"><span class="ng-binding">thrclark@iu.edu</span></span></p>
                            </div>
                        </div>
                        <div class="form-group form-group-sm ng-scope">
                            <div class="col-sm-3 control-label"><span class="ng-binding">Campus(es)</span>:</div>
                            <div class="col-sm-9">
                                <p class="form-control-static"><span class="ng-scope"><span class="ng-binding">Bloomington</span><br ng-if="!$last" class="ng-scope">
                                    </span><span class="ng-scope"><span class="ng-binding">Indianapolis</span><br ng-if="!$last" class="ng-scope">
                                    </span><span class="ng-scope"><span class="ng-binding">East</span><br ng-if="!$last" class="ng-scope">
                                    </span><span class="ng-scope"><span class="ng-binding">Northwest</span><br ng-if="!$last" class="ng-scope">
                                    </span><span class="ng-scope"><span class="ng-binding">South Bend</span><br ng-if="!$last" class="ng-scope">
                                    </span><span class="ng-scope"><span class="ng-binding">Southeast</span><br ng-if="!$last" class="ng-scope">
                                    </span><span class="ng-scope"><span class="ng-binding">Columbus</span><br ng-if="!$last" class="ng-scope">
                                    </span><span class="ng-scope"><span class="ng-binding">Kokomo</span></span></p>
                            </div>
                        </div>
